...
| 名称                                    | 截图                                                         | 方法                                             | 难度 | 代码                                                         |
| --------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------ | ---- | ------------------------------------------------------------ |
| 27.siamese连体网络小样本猫狗品种分类    | <img src="https://enpei-md.oss-cn-hangzhou.aliyuncs.com/img20220828201817.png?x-oss-process=style/wp" style="width:200px;" /> | Siamese network孪生网络、迁移学习、小样本学习    | ⭐️⭐️⭐️  | [codes/27.siamese连体网络小样本猫狗品种分类](./27.siamese连体网络小样本猫狗品种分类) |
