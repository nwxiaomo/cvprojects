...
| 名称                                    | 截图                                                         | 方法                                             | 难度 | 代码                                                         |
| --------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------ | ---- | ------------------------------------------------------------ |
| 24.Web以图搜图系统                      | <img src="https://enpei-md.oss-cn-hangzhou.aliyuncs.com/img20220715195118.png?x-oss-process=style/wp" style="width:200px;" /> | metric-learning、docker、torchserve、tfservering | ⭐️⭐️⭐️⭐️ | [codes/24.Web以图搜图系统](./codes/24.Web以图搜图系统	)   |
