...
| 名称                                     | 截图                                                         | 方法                                             | 难度 | 代码                                                         |
| ---------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------ | ---- | ------------------------------------------------------------ |
| 28.transformer image caption中文看图写话 | <img src="https://enpei-md.oss-cn-hangzhou.aliyuncs.com/img20220909205358.png?x-oss-process=style/wp" style="width:200px;" /> | transformer、image caption                       | ⭐️⭐️⭐️⭐️ | [codes/28.transformer_image_caption中文看图写话](./codes/28.transformer_image_caption中文看图写话) |
